...
public class Endpoints {
    ...
    public static final String ACCOUNT_LIST_BALANCES_ENDPOINT = "/accounts-balances";
    public static final String ACCOUNT_LIST_TRANSACTIONS_ENDPOINT = "/accounts-transactions";
}